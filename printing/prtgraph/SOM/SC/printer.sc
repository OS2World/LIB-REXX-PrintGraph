...
class: VRPrinter, 
    local, classprefix = VRPrinterClass_, external prefix = VRPrinterInstance_, 
    major version = 1, minor version = 1, file stem = printer;
...
methods:
    ...
    ULONG    vrStemFetchLong(PSZ pszStem,
		ULONG index,
		PBOOL pOk);

    --  VRPrinterInstance_vrStemFetchLong

    PSZ    vrStemFetchString(PSZ pszStem,
		ULONG index,
		PBOOL pOk);

    --  VRPrinterInstance_vrStemFetchString

    BOOL    vrStemSetValue(PSZ pszStem,
		ULONG index,
		PSZ pszValue);

    --  VRPrinterInstance_vrStemSetValue

    BOOL    vrStemSetValueLong(PSZ pszStem,
		ULONG index,
		ULONG ulValue);
    ...
    bool    vrRXMethod_ClosePrintJob(LONG argc,
		PRXSTRING argv,
		PLONG argsused,
		PRXSTRING retstr,
		PVRMETHEXTRA rxdata);
    ...
    bool    vrRXMethod_DefineTable(LONG argc,
		PRXSTRING argv,
		PLONG argsused,
		PRXSTRING retstr,
		PVRMETHEXTRA rxdata);
    ...
    bool    vrRXMethod_EndRow(LONG argc,
		PRXSTRING argv,
		PLONG argsused,
		PRXSTRING retstr,
		PVRMETHEXTRA rxdata);
    ...
    bool    vrRXMethod_EndTable(LONG argc,
		PRXSTRING argv,
		PLONG argsused,
		PRXSTRING retstr,
		PVRMETHEXTRA rxdata);
    ...
    bool    vrRXMethod_GoTo(LONG argc,
		PRXSTRING argv,
		PLONG argsused,
		PRXSTRING retstr,
		PVRMETHEXTRA rxdata);
    ...
    bool    vrRXMethod_JobProperties(LONG argc,
		PRXSTRING argv,
		PLONG argsused,
		PRXSTRING retstr,
		PVRMETHEXTRA rxdata);
    ...
    bool    vrRXMethod_PrintJustified(LONG argc,
		PRXSTRING argv,
		PLONG argsused,
		PRXSTRING retstr,
		PVRMETHEXTRA rxdata);
    ...
    bool    vrRXMethod_PrintCentered(LONG argc,
		PRXSTRING argv,
		PLONG argsused,
		PRXSTRING retstr,
		PVRMETHEXTRA rxdata);
    ...
    bool    vrRXMethod_PrintRight(LONG argc,
		PRXSTRING argv,
		PLONG argsused,
		PRXSTRING retstr,
		PVRMETHEXTRA rxdata);
    ...
    bool    vrRXMethod_PrintLeft(LONG argc,
		PRXSTRING argv,
		PLONG argsused,
		PRXSTRING retstr,
		PVRMETHEXTRA rxdata);
    ...
    bool    vrRXMethod_PrintLine(LONG argc,
		PRXSTRING argv,
		PLONG argsused,
		PRXSTRING retstr,
		PVRMETHEXTRA rxdata);
    ...
    bool    vrRXMethod_PrintBox(LONG argc,
		PRXSTRING argv,
		PLONG argsused,
		PRXSTRING retstr,
		PVRMETHEXTRA rxdata);
    ...
    bool    vrRXMethod_PrintBitmap(LONG argc,
		PRXSTRING argv,
		PLONG argsused,
		PRXSTRING retstr,
		PVRMETHEXTRA rxdata);
    ...
    bool    vrRXMethod_PrintFile(LONG argc,
		PRXSTRING argv,
		PLONG argsused,
		PRXSTRING retstr,
		PVRMETHEXTRA rxdata);
    ...
    bool    vrRXMethod_StartCol(LONG argc,
		PRXSTRING argv,
		PLONG argsused,
		PRXSTRING retstr,
		PVRMETHEXTRA rxdata);
    ...
    bool    vrRXMethod_StartRow(LONG argc,
		PRXSTRING argv,
		PLONG argsused,
		PRXSTRING retstr,
		PVRMETHEXTRA rxdata);
    ...
    bool    vrRXMethod_StartTable(LONG argc,
		PRXSTRING argv,
		PLONG argsused,
		PRXSTRING retstr,
		PVRMETHEXTRA rxdata);
    ...
    bool    vrRXMethod_SetHeader(LONG argc,
		PRXSTRING argv,
		PLONG argsused,
		PRXSTRING retstr,
		PVRMETHEXTRA rxdata);
    ...
    bool    vrRXMethod_SetHeaderMode(LONG argc,
		PRXSTRING argv,
		PLONG argsused,
		PRXSTRING retstr,
		PVRMETHEXTRA rxdata);
    ...
    bool    vrRXMethod_SetFooter(LONG argc,
		PRXSTRING argv,
		PLONG argsused,
		PRXSTRING retstr,
		PVRMETHEXTRA rxdata);
    ...
    bool    vrRXMethod_SetMargins(LONG argc,
		PRXSTRING argv,
		PLONG argsused,
		PRXSTRING retstr,
		PVRMETHEXTRA rxdata);
    ...
    bool    vrRXMethod_SetPrinter(LONG argc,
		PRXSTRING argv,
		PLONG argsused,
		PRXSTRING retstr,
		PVRMETHEXTRA rxdata);
    ...
    bool    vrRXMethod_PrinterDialog(LONG argc,
		PRXSTRING argv,
		PLONG argsused,
		PRXSTRING retstr,
		PVRMETHEXTRA rxdata);
    ...
    bool    vrRXMethod_FontDialog(LONG argc,
		PRXSTRING argv,
		PLONG argsused,
		PRXSTRING retstr,
		PVRMETHEXTRA rxdata);
    ...
    bool    vrRXMethod_OpenPrintJob(LONG argc,
		PRXSTRING argv,
		PLONG argsused,
		PRXSTRING retstr,
		PVRMETHEXTRA rxdata);
    ...
    bool    vrRXMethod_NewPage(LONG argc,
		PRXSTRING argv,
		PLONG argsused,
		PRXSTRING retstr,
		PVRMETHEXTRA rxdata);
    ...
    bool    vrRXMethod_PrinterList(LONG argc,
		PRXSTRING argv,
		PLONG argsused,
		PRXSTRING retstr,
		PVRMETHEXTRA rxdata);
    ...
    bool    vrRXMethod_SetHeaderLineFont(LONG argc,
		PRXSTRING argv,
		PLONG argsused,
		PRXSTRING retstr,
		PVRMETHEXTRA rxdata);
    ...
    bool    vrRXMethod_PrintObjectImage(LONG argc,
		PRXSTRING argv,
		PLONG argsused,
		PRXSTRING retstr,
		PVRMETHEXTRA rxdata);
    ...
    bool    vrRXMethod_ResetColHeader(LONG argc,
		PRXSTRING argv,
		PLONG argsused,
		PRXSTRING retstr,
		PVRMETHEXTRA rxdata);
    ...
    bool    vrRXMethod_ResetHeader(LONG argc,
		PRXSTRING argv,
		PLONG argsused,
		PRXSTRING retstr,
		PVRMETHEXTRA rxdata);
    ...
    bool    vrRXMethod_AbortPrintJob(LONG argc,
		PRXSTRING argv,
		PLONG argsused,
		PRXSTRING retstr,
		PVRMETHEXTRA rxdata);
    ...
    bool    vrRXMethod_BlockFits(LONG argc,
		PRXSTRING argv,
		PLONG argsused,
		PRXSTRING retstr,
		PVRMETHEXTRA rxdata);
    ...
    bool    vrRXMethod_LineFits(LONG argc,
		PRXSTRING argv,
		PLONG argsused,
		PRXSTRING retstr,
		PVRMETHEXTRA rxdata);
    ...
    bool    vrRXMethod_SetProgressTexts(LONG argc,
		PRXSTRING argv,
		PLONG argsused,
		PRXSTRING retstr,
		PVRMETHEXTRA rxdata);
    ...
    bool    vrRXMethod_MoveX(LONG argc,
		PRXSTRING argv,
		PLONG argsused,
		PRXSTRING retstr,
		PVRMETHEXTRA rxdata);
    ...
    bool    vrRXMethod_MoveY(LONG argc,
		PRXSTRING argv,
		PLONG argsused,
		PRXSTRING retstr,
		PVRMETHEXTRA rxdata);
    ...
    bool    vrRXMethod_PrintWinImage(LONG argc,
		PRXSTRING argv,
		PLONG argsused,
		PRXSTRING retstr,
		PVRMETHEXTRA rxdata);
    ...
    bool    vrRXMethod_LoadResMod(LONG argc,
		PRXSTRING argv,
		PLONG argsused,
		PRXSTRING retstr,
		PVRMETHEXTRA rxdata);
    ...
    bool    vrRXMethod_FreeResMod(LONG argc,
		PRXSTRING argv,
		PLONG argsused,
		PRXSTRING retstr,
		PVRMETHEXTRA rxdata);
    ...
    bool    vrRXMethod_PrintJPEG(LONG argc,
		PRXSTRING argv,
		PLONG argsused,
		PRXSTRING retstr,
		PVRMETHEXTRA rxdata);
    ...
    bool    vrRXMethod_StringLength(LONG argc,
		PRXSTRING argv,
		PLONG argsused,
		PRXSTRING retstr,
		PVRMETHEXTRA rxdata);
    ...
    bool    vrRXMethod_GotoX(LONG argc,
		PRXSTRING argv,
		PLONG argsused,
		PRXSTRING retstr,
		PVRMETHEXTRA rxdata);
    ...
    bool    vrRXMethod_GotoY(LONG argc,
		PRXSTRING argv,
		PLONG argsused,
		PRXSTRING retstr,
		PVRMETHEXTRA rxdata);
    ...
    bool    vrRXMethod_GotoTab(LONG argc,
		PRXSTRING argv,
		PLONG argsused,
		PRXSTRING retstr,
		PVRMETHEXTRA rxdata);
    ...
    bool    vrRXMethod_DrawLine(LONG argc,
		PRXSTRING argv,
		PLONG argsused,
		PRXSTRING retstr,
		PVRMETHEXTRA rxdata);
    ...
    bool    vrRXMethod_PrintBullet(LONG argc,
		PRXSTRING argv,
		PLONG argsused,
		PRXSTRING retstr,
		PVRMETHEXTRA rxdata);
    ...
    bool    vrRXMethod_SaveJobProps(LONG argc,
		PRXSTRING argv,
		PLONG argsused,
		PRXSTRING retstr,
		PVRMETHEXTRA rxdata);
    ...
    bool    vrRXMethod_ReadJobProps(LONG argc,
		PRXSTRING argv,
		PLONG argsused,
		PRXSTRING retstr,
		PVRMETHEXTRA rxdata);
    ...
    MRESULT    vrWM_INITCAP(HWND hWnd,
		ULONG msg,
		MPARAM mp1,
		MPARAM mp2);
